...
\def\namemathcol {Corollary}       % Nombre de los colorarios
\def\namemathdefn {Definition}     % Nombre de las definiciones
\def\namemathej {Example}          % Nombre de los ejemplos
\def\namemathlem {Lemma}            % Nombre de los lemas
\def\namemathobs {Observation}     % Nombre de las observaciones
\def\namemathprp {Proposición}     % Nombre de las proposiciones
\def\namemaththeorem {Theorem}     % Nombre de los teoremas
